...
import { Search, Plus, ExternalLink, CheckCircle, Clock, Trash2 } from "lucide-react";
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
                    <thead>
                        <tr style={{ borderBottom: "1px solid var(--card-border)" }}>
                            ...
                            <th style={{ padding: "1rem" }}>App. Sent</th>
                    ...
                    <tbody>
                        {filteredOffers.map((offer) => (
                            ...
                            >
                                ...
                                <td style={{ padding: "1rem" }}>{offer.application_sent ? "Yes" : "No"}</td>
